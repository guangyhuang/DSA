...
def get_args():
    ...
    parser.add_argument('--config_file', type=str, default='configs/dsa/pvqvae.yaml',
                        help='path of config file')
    parser.add_argument('--name', type=str, default='pvqvae',
    ...
    parser.add_argument('--load_path', type=str, default='scripts/OUTPUT/pvqvae/checkpoint/000029e_18749iter.pth',
