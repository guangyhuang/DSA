...
def get_args():
    ...
    parser.add_argument('--image_dir', type=str, default=r'D:\A_image_inpainting\code\a_second\PUT-main\data\naturalscene\b\butte\00000001.jpg',
                        help='gt images need to be loaded') 
    parser.add_argument('--mask_dir', type=str, default=r"D:\A_image_inpainting\code\a_second\PUT-main\data\irregular-mask\testing_mask_dataset\02691.png",
    ...
    parser.add_argument('--save_masked_image', action='store_true', default=True,
                        help='Save the masked image, i.e., the input')
    parser.add_argument('--raster_order', action='store_true', default=True,
