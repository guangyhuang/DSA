...
IMAGE_EXTENSIONS = ['bmp', 'jpg', 'jpeg', 'pgm', 'png', 'PNG', 'tif', 'tiff', 'webp', 'JPEG']
...
def main(args):
    ...
    for batch in tqdm.tqdm(dataloader):
        ...
        ssim = get_SSIM(gt, res, full=False, win_size=None)
        # ssim = get_SSIM(gt, res, full=False, win_size=None)
...
def get_args():
    ...
    # parser.add_argument('--gt_dir', type=str, default=r'C:\Users\hgy\Desktop\misf-main\result\places\gt',
    #                     help='directory to of ground truth')
    # parser.add_argument('--result_dir', type=str, default=r'D:\A_image_inpainting\code\A_test\ctsdg-main\pl2\60',
    #                     help='directory to of generated results')
    # parser.add_argument('--gt_dir', type=str, default=r'C:\Users\hgy\Desktop\misf-main\result\street\14-gt',`    #                     help='directory to of ground truth')
    # parser.add_argument('--result_dir', type=str, default=r'C:\Users\hgy\Desktop\misf-main\result\street\14-fake-60',
    #                     help='directory to of generated results')

    parser.add_argument('--gt_dir', type=str, default=r'D:\A_image_inpainting\code\A_test\ctsdg-main\result\ffhq\gt',
                        help='directory to of ground truth')
    parser.add_argument('--result_dir', type=str, default=r'D:\A_image_inpainting\code\A_test\ctsdg-main\result\ffhq\60-ffhq-60',
                        help='directory to of generated results')
