...
parser.add_argument('--path1', type=str, default=r'D:\A_image_inpainting\code\A_sec\PUT-xg2-transformer - py -3 -3\scripts\RESULT\ffhq_val_e9\gt',
...
parser.add_argument('--path2', type=str, default=r'D:\A_image_inpainting\code\A_sec\PUT-xg2-transformer - py -3 -3\scripts\RESULT\ffhq_val_e9\rec',
                    help='Paths to the generated images or txt file contain the relative path of images')
