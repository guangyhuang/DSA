...
def get_args():
    ...
    parser.add_argument('--config_file', type=str, default='configs/ffhq.yaml',
                        help='path of config file')
    parser.add_argument('--name', type=str, default='test',
                        help='the name of this experiment, if not provided, set to'
                             'the name of config file') 
    parser.add_argument('--output', type=str, default='scripts/OUTPUT',
                        help='directory to save the results')    
    parser.add_argument('--log_frequency', type=int, default=10, 
                        help='print frequency (default: 10)')
    # parser.add_argument('--load_path', type=str, default='scripts/OUTPUT/pvqvae_ffhq_21/checkpoint/000149e_93749iter.pth',
    #                     help='path to model that need to be loaded, '
    #                          'used for loading pretrained model')
    parser.add_argument('--load_path', type=str, default='scripts/OUTPUT/py3/checkpoint/000149e_93749iter.pth',
                        help='path to model that need to be loaded, '
                             'used for loading pretrained model')
    ...
    parser.add_argument('--tensorboard', action='store_true', default="auto_resume",
