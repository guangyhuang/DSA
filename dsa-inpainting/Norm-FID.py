...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_real', type=str, default=r'D:\A_image_inpainting\code\A_sec\PUT-33\scripts\RESULT\pl2\places2-c_val_e14\gt')
    ...
    parser.add_argument('--path_fake', type=str, default=r'D:\A_image_inpainting\code\A_sec\PUT-33\scripts\RESULT\pl2\places2-c_val_e14\rec')
