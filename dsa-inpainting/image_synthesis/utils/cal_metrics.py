...
def get_SSIM(img1, img2, full=True, win_size=None):
    ...
    def get_one_pair_image(im1, im2):
        ...
        score = structural_similarity(im1, im2, multichannel=True, data_range=255, win_size=51)
        # if len(im1.shape) == 3:
        #     if im1.shape[-1] == 3:
        ...
        # else:
        #     score = structural_similarity(im1_, im2_, full=full, win_size=win_size, multichannel=True, data_range=255)
        return score
